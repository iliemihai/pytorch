...
Acest repo contine tutoriale ce acopera implementarea si intelegerea modelelor de seq2seq alaturi de transformer folosind [PyTorch](https://github.com/pytorch/pytorch) 1.4 and [TorchText](https://github.com/pytorch/text) 0.5 si Python 3.6.

## Getting Started

Pentru a instala requirements:
``` bash
cd pytorch_seq2seq
...
sudo pip3 install -r requirments.txt # install dependencies
#to exit environment
deactivate
```

We'll also make use of spaCy to tokenize our data. To install spaCy, follow the instructions [here](https://spacy.io/usage/) making sure to install both the English and Romanian models with:

``` bash
python3.6 -m spacy download en
python3.6 -m spacy download ro
```
